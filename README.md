...
<h3 align="center">Netflix App</h3>
  ...
  <p align="center">
    Create React app (Movies List) as part of Vangwe's onboarding
    <br />
...
It's made to create a movie list app and it's strongly based on Netflix as the name shows.
...
1. Get a free API Key at [https://developers.themoviedb.org](https://example.com)
2. Clone the repo
   ```sh
   git clone https://github.com/Vangwe/netflix-react-belen/
   ```
...
Project Link: [https://github.com/Vangwe/netflix-react-belen](https://github.com/Vangwe/netflix-react-belen)
